...
function checkAnswer() {
    ...
    if (foundCategory) {
        ...
        if (matchedCategories.size === Object.keys(CATEGORIES).length) {
            ...
            // Prompt the player to submit their initials to the leaderboard
            const finalResets = (typeof resetCount !== 'undefined') ? resetCount : 0;
            setTimeout(() => showScoreSubmission(totalFails, finalResets), 800);
        }
    } else {
