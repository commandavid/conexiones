...
// published. Emails are stored in the Firestore `emails` collection (separate
// from the per-puzzle `leaderboards` results), keyed by the (normalised)
// address so the same email is never stored twice. Actually sending the
// notification emails is handled elsewhere/later.
// ==========================================================================
...
try {
const ref = db.collection('emails').doc(docId);
